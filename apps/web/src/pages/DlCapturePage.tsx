...
type PickerKind = "camera" | "library";
...
export default function DlCapturePage() {
  ...
  const [lastPicker, setLastPicker] = useState<PickerKind>("camera");
  ...
  const onTakeFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    setLastPicker("camera");
    onInputFile(e);
  };

  const onLibraryFile = (e: React.ChangeEvent<HTMLInputElement>) => {
    setLastPicker("library");
    onInputFile(e);
  };
      ...
      <div style={card}>
        ...
        {confirming ? (
          <div style={{ display: "flex", gap: 10, marginTop: 10 }}>
            ...
            >
              {lastPicker === "library" ? "Choose Another Photo" : "Retake"}
            </button>
            <button
              type="button"
