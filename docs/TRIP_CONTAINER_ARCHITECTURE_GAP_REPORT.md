...
| **6 — Dispatch board → trips** | `list_*_for_board` for trips; load board deprecated or secondary. | `DeprecatedDispatchPage`, `dispatch.py` router, services | Board sorting, unassigned | **Trip number** search continuity |
