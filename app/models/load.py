"""Load model for dispatch. Status: unassigned, assigned, dispatched, arrived_pickup, in_transit, arrived_delivery, delivered, issue_hold."""
...
class Load(Base):
    ...
    status: Mapped[str] = mapped_column(String(32), nullable=False, server_default="unassigned")
